...
import style from "./style/policies.module.css";
const Policies = () => {
  return (
    <div className={style.container}>
      ...
      <ul>
        ...
        <li>
          Airline seats and hotel rooms are subject to availability at the time
          of booking.
        </li>
        <li>
          ...
          booking. Passengers furnishing incorrect age details may incur penalty
        ...
        <li>
          Any other items not mentioned under Inclusions are not included in the
          cost of the booking.
        </li>
        <li>
        ...
        <li>
          Cost of deviation and cost of extension of the validity on your ticket
          is not included.
        </li>
        <li>
        ...
        <li>
          Dudhsagar Waterfalls is closed in the monsoon (June - September).
        </li>
        <li>
          Activities related to water sports are subject to weather and wind
          conditions on the ground.
        </li>
        <li>
          The cost of mentioned tours and transfer is not valid between 6 pm to
          8 am.
        </li>
      </ul>
    </div>
